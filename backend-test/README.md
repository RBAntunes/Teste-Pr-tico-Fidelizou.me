...
* After the competition is over, generate a table of the winners ( localhost:3000/winners );
* You can use any language, framework or technology you want;

## Starting the database

The database uses a docker for its functioning, which can be started by using the command terminal 'docker-compose up' in the Backend root folder.